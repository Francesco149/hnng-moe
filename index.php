...
if (isset($_SERVER['HTTP_USER_AGENT']) && 
    ...
    header('X-UA-Compatible: IE=edge'); // <meta http-equiv="X-UA-Compatible" content="IE=edge">
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <link href="<?php echo $hnngConf['siteroot']; ?>/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?php echo $hnngConf['siteroot']; ?>/css/font-awesome.min.css" rel="stylesheet">
        <link href="<?php echo $hnngConf['siteroot']; ?>/style.css?t=<?php echo time(); ?>" rel="stylesheet">
        <link href="<?php echo $hnngConf['siteroot']; ?>/css/bootstrap-social.css" rel="stylesheet">
        <link rel="shortcut icon" href="favicon.ico?t=<?php echo time(); ?>" type="image/x-icon">
        ...
        <meta property="og:description" content="URL shortening and file sharing for moe lovers">
        <meta property="og:type" content="website">
        <meta property="og:url" content="<?php echo $hnngConf['siteroot']; ?>">
        <meta property="og:image" content="<?php echo $hnngConf['siteroot']; ?>/img/rikka.png">
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo $hnngConf['siteroot']; ?>">HNNG, Moe&#126; Link Shortener</a>
            </div>
        ...
        <div class="container">
            ...
            <p>
                <a class="btn btn-social-icon btn-twitter"
                    target="_blank" href="https://twitter.com/share?url=<?php echo urlencode($hnngConf['siteroot']); ?>&amp;text=<?php echo urlencode('hnng.moe, url shortening and file sharing for moe lovers'); ?>&amp;via=roriicon&amp;hashtags=moedomain"
                >
                  <i class="fa fa-twitter"></i>
                </a>
                <a class="btn btn-social-icon btn-facebook"
                    onclick="FB.ui({method: 'share', href: '<?php echo $hnngConf['siteroot']; ?>'}, function(response){});return false;"
                >
                  <i class="fa fa-facebook"></i>
                </a>
                <a class="btn btn-social-icon btn-google-plus"
                    href="https://plus.google.com/share?url=<?php echo urlencode($hnngConf['siteroot']); ?>" 
                ...
                <a class="btn btn-social-icon btn-tumblr"
                    target="_blank" href="http://www.tumblr.com/share?v=3&amp;u=<?php echo urlencode($hnngConf['siteroot']); ?>&amp;t=HNNG,%20Moe&#126;%20Link%20Shortener">
                  <i class="fa fa-tumblr"></i>
                </a>
            </p>
            <!-- social buttons end -->
            
            <h6>Created by Franc[e]sco <a href="https://twitter.com/roriicon">@roriicon</a></h6>
            </div>
            
            <div class="footer jumbotron">
                <h6>
                    If the above boxes are completely opaque or completely transparent, I highly 
                    recommend that you upgrade to a better and up-to-date browser, such as 
                    <a href="https://www.mozilla.org/en-US/firefox/all/">Firefox</a>.
                </h6>
            </div>
        </div>
        ...
        <script src="<?php echo $hnngConf['siteroot']; ?>/js/bootstrap.min.js"></script>
    </body>
</html>