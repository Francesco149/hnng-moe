...
<p>You will have to send a POST request and the file form value must be named "file".</p>
<p>The response will be formatted in JSON and will contain both the link to the file and the deletion link.
If anything goes wrong, status will contain a description of the error.</p>
<pre>{"url":"http://hnng.moe/f/...","deletelink":"http://www.hnng.moe/deleteupload.php?key=...","status":"OK"}</pre>
<p>&nbsp;</p>
...
<p>You can get ShareX <a target="_blank" href="http://getsharex.com/">here</a>.</p>
<p>&nbsp;</p>
...
<p>Go to Settings &#8594; Account Settings &#8594; URL Shortening &#8594; Custom and enter</p>
